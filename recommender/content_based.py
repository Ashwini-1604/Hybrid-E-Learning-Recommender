...
be downloaded (e.g. no internet on first run, restricted campus wifi),
this automatically falls back to TF-IDF so the app never crashes — it just
gets slightly less "semantic" and slightly more "keyword-based".
"""
